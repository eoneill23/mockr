    ...
    return (
      <div className='interview-note-card shadow'>
        ...
        <form id={'score-form-' + props.id} className='' onChange={event => props.fs.score(props.id, event.target.value)}>
          <label><input type='radio' name='score' value='1' checked={getChecked(1)}/>Unsatisfactory<br/></label>
          <label><input type='radio' name='score' value='2' checked={getChecked(2)}/>Needs Work<br/></label>
          <label><input type='radio' name='score' value='3' checked={getChecked(3)}/>Good<br/></label>
          <label><input type='radio' name='score' value='4' checked={getChecked(4)}/>Exceptional<br/></label>
        </form>
      </div>
    );
  } else {
